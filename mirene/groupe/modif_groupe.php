...
.social-buttons {
  ...
  border-radius: 6px; 
	...
	<button class="btn btn-dark btn-lg"><span class="fa fa-print fa-2x"> imprimer</span><br></button>
<button class="btn btn-success btn-lg"><span class="fa fa-info fa-2x " >modifier</span><br></button>
<button class="btn btn-danger btn-lg"><span class="fa fa-trash fa-2x " aria-hidden="true"> supprime</span><br></button>
<button class="btn btn-info btn-lg"><span class="fa fa-tag fa-2x " aria-hidden="true"> retour</span><br> </button>
<button class="btn btn-danger btn-lg"><span class="fa  fa-bars fa-2x" aria-hidden="true">lister</span><br></button>
<button class="btn btn-info btn-lg"><span class="fa fa-times fa-2x " aria-hidden="true">quitter</span><br> </button>
</div>
