...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="main/owl.carousel.min.css">
...
<body id="page-top">
  ...
  <div class="content">
    ...
    <div class="container">
      <h2 class="mb-5">Liste Des Groupe</h2>
 ...
 <?php 
    $resultat=mysqli_query( $bdd,'SELECT * FROM categorie');
	while($donnee=mysqli_fetch_assoc($resultat)){
		$Id_categorie=$donnee['Id_categorie'];
    echo ' <th scope="row">';
    echo'  <label class="control control--checkbox">';
    echo' <input type="checkbox"/>';
    echo '<div class="control__indicator">';
		echo '<tr>';
		echo "<th>".$donnee['Id_categorie']." </th>";
		echo "<th>".$donnee['Nom']." </th>";
		echo "<th>".$donnee['Privilege']." </th>";
    echo "<th>".$donnee['Id_montant']." </th>";
		echo "<th>";
			echo "<a href='modif_groupe.php?Id_categorie=$Id_categorie' >Modifier</a>";
			echo ' / ';
			echo "<a href='supprimer.php?Id_categorie=$Id_categorie'>Supprimer</a>";
