...
<body>
	...
	<div id="booking" class="section">
		<div class="section-center">
			...
			<div class="container" id="section-center">
				<div class="row">
					<div class="col-md-7 col-md-push-5">
						<div class="booking-cta">
							<h1>AJOUTER UN GROUPE </h1>
							<p>Indication: pour Ajouter un groupe il suffit juste de remplir le petit formulaire
							</p>
						</div>
					</div>
						...
						<div class="booking-form">
							<form method="post">
								<div class="form-group">
									...
									<input class="form-control" type="text" placeholder="" name="Id_categorie">
								</div>
								<div class="form-group">
									<span class="form-label">Nom du groupe</span>
									<input class="form-control" type="text" placeholder="Entrez le nom de votre groupe" name="Nom">
								</div>
								<div class="form-group">
									<span class="form-label">Id_montant</span>
									<input class="form-control" type="text" placeholder="Entrez id montant" name="Id_montant" >
								</div>
								...
								<div class="form-btn">
									<input type="submit" class="submit-btn">ajouter</button>
								</div>
							</form>
						</div>
					</div>
...
<?php
	...
	if($_POST){
		if($_POST['Id_categorie']!="" and $_POST['Nom']!="" and $_POST['Privilege']!=""){
			$Id_categorie=addslashes(Htmlspecialchars($_POST['Id_categorie']));
			$Nom=addslashes(Htmlspecialchars($_POST['Nom']));
			$Privilege=addslashes(Htmlspecialchars($_POST['Privilege']));
			$Id_montant=addslashes(Htmlspecialchars($_POST['Id_montant']));
		
		extract($_POST);
		$sql="INSERT INTO  categorie VALUES('$Id_categorie','$Nom','$Privilege','$Id_montant')";
		$resultat=mysqli_query($bdd,$sql);
		if($resultat){
			echo '<script> alert("groupe enregistrer avec succes")</script>';
		}
		else{
